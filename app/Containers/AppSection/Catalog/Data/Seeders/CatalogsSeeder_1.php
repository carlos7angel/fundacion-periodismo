...
class CatalogsSeeder_1 extends ParentSeeder
{
    ...
    public function run(CreateCatalogTask $task): void
    {
        ...
        $task->run(['id' => 6, 'code' => 'CTX', 'name' => 'Circunstancia del hecho']);
        $task->run(['id' => 7, 'code' => 'ARE', 'name' => 'Acción/respuesta del estado']);
        $task->run(['id' => 8, 'code' => 'APE', 'name' => 'Acciones de desprotección del estado']);
        $task->run(['id' => 9, 'code' => 'RGP', 'name' => 'Respuesta/Acción de gremios periodísticos']);
        $task->run(['id' => 10, 'code' => 'ROS', 'name' => 'Respuesta/Acción de Organizaciones de la Sociedad Civil']);
        $task->run(['id' => 11, 'code' => 'SOU', 'name' => 'Fuente de información']);
    }
}
