...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <li class="breadcrumb-item text-white fw-bold lh-1">Anuales</li>
    </ul>
@endsection

@section('headline')
    <div class="page-title d-flex align-items-center me-3">
        <h1 class="page-heading d-flex text-white fw-bolder fs-1 flex-column justify-content-center my-0">Informes Anuales
            <span class="page-desc text-white opacity-50 fs-6 fw-bold pt-3">Listado de documentos por gestión</span>
        </h1>
    </div>
    ...
    <div id="kt_app_content" class="app-content">
        ...
        <div class="d-flex flex-wrap flex-stack pb-7">
            ...
            <div class="d-flex flex-wrap my-1">
                <a href="{{ route('admin_document_create', ['type' => 'ANUAL']) }}" class="btn btn-primary"><i class="ki-outline ki-file-added fs-3 me-1"></i>Nuevo Informe</a>
            </div>
        </div>
