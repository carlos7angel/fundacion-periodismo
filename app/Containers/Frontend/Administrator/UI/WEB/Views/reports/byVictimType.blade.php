...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <li class="breadcrumb-item text-white fw-bold lh-1">Por tipo de víctima</li>
    </ul>
@endsection
                ...
                <div class="card card-flush h-lg-100">
                    <div class="card-header pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-primary text-uppercase kt_report_by_victim_type_title"></span>
                            ...
                            <div class="card-title d-flex flex-column">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fs-2hx fw-bold text-gray-900 ms-3 lh-1 ls-n2"
                                          id="kt_report_by_victim_type_total">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-10" id="kt_report_by_victim_type_card">
            ...
            <div class="col-12 mb-5 mb-xl-10">
                <div class="card card-flush h-xl-100">
                    <div class="card-header pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-primary">
                                GRÁFICO:
                                <span class="text-uppercase kt_report_by_victim_type_title"></span>
                            </span>
                    ...
                    <div class="card-body pt-6">
                        <div id="kt_report_by_victim_type_chart" class="card-rounded-bottom" style="height: 400px"
                             data-url="{{ route('admin_reports_by_victim_type_json') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-flush h-xl-100">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-semibold fs-7 kt_report_by_victim_type_title"></span>
                        </h3>
                        <div class="card-toolbar">
                    ...
                    <div class="card-body py-3">
                        <div class="table-responsive">
                            <table class="table table-row-bordered table-row-gray-300 align-middle gs-0 gy-3" id="kt_report_by_victim_type_table">
                                <thead>
...
@section('scripts')
    ...
    <script src="{{ asset('themes/admin/js/custom/reports/by_victim_type.js') }}"></script>
@endsection