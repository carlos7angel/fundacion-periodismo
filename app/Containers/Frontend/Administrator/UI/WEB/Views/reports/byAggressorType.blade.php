...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <li class="breadcrumb-item text-white fw-bold lh-1">Por tipo de agresor</li>
    </ul>
@endsection
                    ...
                    <div class="card-header pt-5">
                        <div class="card-title d-flex flex-column">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fs-2hx fw-bold text-gray-900 ms-3 me-2 lh-1 ls-n2"
                                      id="kt_report_by_aggressor_type_total">0</span>
                            </div>
                            <span class="text-gray-500 pt-1 fw-semibold fs-6">Denuncias por tipo de agresor</span>
                        </div>
                    </div>
                    <div class="card-body pt-5" id="kt_report_by_aggressor_type_card">
                        <div class="d-flex flex-stack">
                            <div class="text-gray-700 fw-bold fs-6 me-2">Loading...</div>
                            <div class="d-flex align-items-center">
                ...
                <div class="card card-flush h-xl-100">
                    <div class="card-header pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-900">Número de denuncias por tipo de agresor</span>
                    ...
                    <div class="card-body pt-6">
                        <div id="kt_report_by_aggressor_type" class="card-rounded-bottom" style="height: 400px"
                             data-url="{{ route('admin_reports_by_aggressor_type_json') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 mb-5 mb-xl-10">
                <div class="card card-flush h-xl-100">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">Lista de Denuncias</span>
                            <span class="text-muted mt-1 fw-semibold fs-7">Resultado de acuerdo a los criterios del reporte</span>
                        </h3>
                        <div class="card-toolbar">
                    ...
                    <div class="card-body py-3">
                        <div class="table-responsive">
                            <table class="table table-row-bordered table-row-gray-300 align-middle gs-0 gy-3" id="kt_report_by_aggressor_type_table">
                                <thead>
...
@section('scripts')
    ...
    <script src="{{ asset('themes/admin/js/custom/reports/by_aggressor_type.js') }}"></script>
@endsection