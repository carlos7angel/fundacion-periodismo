                    ...
                    <div class="row g-8 mb-5">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-2 row-cols-lg-2">
                                ...
                                <div class="col d-flex justify-content-between align-items-center">
                                    <div>Al: </div>
                                    <input type="text" class="form-control form-control-sm form-control-solid-x datatable-input datepicker_flatpickr" data-col-index="6" placeholder="DD/MM/YYYY" name="kt_search_date2" />
                                </div>
                            </div>
                        </div>
                    </div>
