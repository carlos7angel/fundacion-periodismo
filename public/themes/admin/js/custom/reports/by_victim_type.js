...
var KTReports1 = function () {
    ...
    var initChart = function () {
        ...
        element = document.getElementById("kt_report_by_victim_type_chart");
        if (!element) { return; }
    ...
    var renderTable = function (data) {
        ...
        let table_container_name = '#kt_report_by_victim_type_table';
    ...
    var renderCard = function(data, total) {
        ...
        const container = document.getElementById('kt_report_by_victim_type_card');
        container.innerHTML = '';
        ...
        const container_total = document.getElementById('kt_report_by_victim_type_total');
    ...
    var reloadReport = function(start_value = null, end_value = null, category_value = null) {
        ...
        var container = document.getElementById("kt_report_by_victim_type_chart")
    ...
    var renderTitle = function (title) {
        $('.kt_report_by_victim_type_title').html(title);
    }
